    ...
    "pets":
        {
            ...
            "kangaroo": {
                ...
                "ability": {
                    "description": (
                        "Friend ahead attacks: Gain (+2/+2)/(+4/+4)/(+6/+6)."
                    ),
            ...
            "penguin": {
                ...
                "ability": {
                    "description": (
                        "End turn: Give three lvl 2 and 3 friends"
                        " (+1/+1)/(+2/+2)/(+3/+3)."
                    ),
                    "trigger": Trigger.EndOfTurn,
                    "triggeredBy": "player",
            ...
            "skunk": {
                ...
                "ability": {
                    "description": (
                        "Start of battle: Reduce HP of the highest enemy by"
                        " 33%/66%/99%."
                    ),
                    "trigger": Trigger.StartOfBattle,
                    "triggeredBy": "player",
            ...
            "gorilla": {
                ...
                "ability": {
                    "description": (
                        "Hurt: Gain Coconut Shield (1/2/3 times per battle)."
                    ),
                    "trigger": Trigger.Hurt,
                    "triggeredBy": "self",
                },
